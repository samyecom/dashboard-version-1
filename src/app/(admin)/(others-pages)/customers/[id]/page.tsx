...
// NOTE: This interface is modified to match an *incorrect* PageProps type
// generated by your build environment, where 'params' and 'searchParams'
// are expected to be Promises.
// The standard Next.js app directory 'PageProps' has these directly as objects.
// This change is a workaround for a build configuration or dependency issue
// and will require you to 'await' params and searchParams inside your component
// to access their actual values.
interface CustomerDetailsPageProps {
    // Change params and searchParams to be Promises to match the generated PageProps type
    // The payload of params should match the generated SegmentParams type for the route ([id] -> { id: string | string[] | undefined })
    params: Promise<{ id: string | string[] | undefined }>;
    searchParams: Promise<{ [key: string]: string | string[] | undefined }>;
}

export default async function CustomerDetailsPage({ params }: CustomerDetailsPageProps) {
    const customerId = await (await params).id;
  
    const customer: Customer = mockCustomers.find(cust => cust.id === customerId) || {
